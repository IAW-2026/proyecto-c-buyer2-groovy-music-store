...
export default async function CheckoutPage({ searchParams }: { searchParams: Promise<{ seller?: string }>; }) {
    ...
    // agregar detalles de productos a cada item del carrito
    ...
    const origenCpVendedor = "8000";
    const destinoCpComprador = "1000";
    const pesoTotal = 0.5;
    
    const envio = await getShippingEstimate(origenCpVendedor, destinoCpComprador, pesoTotal);

    // calcular total = productos + envio
                    ...
                    <div className="h-fit sticky top-6">
                        <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
                            ...
                            <div className="flex justify-between items-center border-t border-border pt-5 mb-8">
                                ...
                                <span className="font-syne font-bold text-3xl text-primary">${totalAPagar.toFixed(2)}</span>
                            </div>
